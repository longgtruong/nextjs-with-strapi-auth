...
export default function Home() {
  const { isAuthenticated, logout, me, loading } = useAuth();
  ...
  return (
    <PageLayout>
      <section className="bg-gray-900">
        <div className="h-screen flex flex-col items-center px-6 py-8 mx-auto md:h-screen">
          <div className="w-full rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl text-center leading-tight tracking-tight md:text-2xl text-white">
                Logged in as
              </h1>
              {!loading ? (
